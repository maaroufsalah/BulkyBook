...
namespace BulkyBook.DataAccess.Migrations
{
    public partial class AddStoredProcForCoverType : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"CREATE PROC usp_CoverTypes
                        AS
                        BEGIN
                            SELECT * FROM dbo.CoverTypes
                        END");

            migrationBuilder.Sql(@"CREATE PROC usp_CoverType
                        @Id int
                        AS
                        BEGIN
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE usp_CoverTypes");
            migrationBuilder.Sql(@"DROP PROCEDURE usp_CoverType");
